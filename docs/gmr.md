...
```bash
python scripts/smplx_to_robot.py --smplx_file /data/group1/GMR-master/assets/body_models/smplx/SMPLX_FEMALE.pkl --robot unitree_g1 --save_path /data/group1/GMR-master/output_directory --rate_limit
```
